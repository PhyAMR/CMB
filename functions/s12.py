...
if __name__ == '__main__':
    ...
    logger.info("--- S12 Performance and Accuracy Test ---")
    ...
    try:
        ...
        logger.error(f"Error: Matrix file not found at {matrix_path}")
        logger.error("Please ensure you are running this script from the project's root directory.")
        sys.exit(1)
    ...
    # --- Report Results ---
    logger.info(f"Interval [cos(theta)]: [{a}, {b}] (Theta: [60, 180] degrees)")
    logger.info("\nAnalytical Calculation:")
    logger.info(f"  Result: {s12_analytical}")
    logger.info(f"  Execution Time: {analytical_duration:.6f} seconds")

    logger.info("\nNumerical Calculation:")
    logger.info(f"  Result: {s12_numerical_val}")
